...
A Web application boilerplate using AngularJS Material with client-side authentication and authorization support, built on top of [angularjs-gulp-browserify-boilerplate](https://github.com/jakemmarsh/angularjs-gulp-browserify-boilerplate).

---

### Getting up and running
1. Install node.js and its package manager (npm).  You can get them from [http://nodejs.org/](http://nodejs.org/).
